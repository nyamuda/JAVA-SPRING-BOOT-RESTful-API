...
public class DefinitionController {
    ...
    @ResponseBody
    public ResponseEntity<Definition> getDefinition(@PathVariable("curriculumId") int curId,
            @PathVariable("termId") int termId) {
        return ResponseEntity.ok().body(defService.getDefinition(curId, termId));
    }

    // save definition
    @PostMapping("definition/save")
    @ResponseBody
    public ResponseEntity<Object> saveDefinition(@Valid @RequestBody Definition definition) {
